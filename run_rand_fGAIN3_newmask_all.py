...
if __name__ == "__main__":
    ...
    try:
        ...
        for i in range(2,204):
            x_df_i = x_df.iloc[:,50*(i-1):50*i]
            #return x_df_i
        x_df_1 = x_df.iloc[:,1:50]
        x_df_204 = x_df.iloc[:,10150:len(x_df.columns)]
    ...
    for i in range(1,205):
        imputated_data_i, rmse_i,SCC_i = main(x_df_i, missing_rate, batch_size, hint_rate, alpha, iterations, loss_func)
        #return imputated_data_i,rmse_i,SCC_i
    #imputated_data1, rmse1,SCC1 = main(x_df1, missing_rate, batch_size, hint_rate, alpha, iterations, loss_func)
    #imputated_data1, rmse1 = main(x_df1, missing_rate, batch_size, hint_rate, alpha, iterations, loss_func)
    #imputated_data2 , rmse2,SCC2 = main(x_df2, missing_rate, batch_size, hint_rate, alpha, iterations, loss_func)
    #imputated_data3 , rmse3,SCC3 = main(x_df3, missing_rate, batch_size, hint_rate, alpha, iterations, loss_func)
...
#imputated_data = [imputated_data1,imputated_data2,imputated_data3,imputated_data4,imputated_data5]
    ...
    for i in range(1,205):
        outputFileName_i = "/student/tsi2/r-venv/ra-code/missing_all/{0}_{1}imputated_data_norm_newmask_{2}.csv".format(dataFPath[-11:-4], loss_func,i)

        np.savetxt(outputFileName_i, imputated_data_i, delimiter=",")
        #print(rmse_i)
        #SCC_i.to_csv("/student/tsi2/r-venv/ra-code/missing/scc_i_newmask.csv")
        #return outputFileName_i 

    #outputFileName1 = "/student/tsi2/r-venv/ra-code/missing_all/{0}_{1}imputated_data_norm_newmask_1.csv".format(dataFPath[-7:-4], loss_func)
    #np.savetxt(outputFileName1, imputated_data1, delimiter=",")

    #outputFileName2 = "/student/tsi2/r-venv/ra-code/missing_all/{0}_{1}imputated_data_norm_newmask_2.csv".format(dataFPath[-7:-4], loss_func)
    #np.savetxt(outputFileName2, imputated_data2, delimiter=",")
     
    #outputFileName3 = "/student/tsi2/r-venv/ra-code/missing_all/{0}_{1}imputated_data_norm_newmask_3.csv".format(dataFPath[-7:-4], loss_func)
    #np.savetxt(outputFileName3, imputated_data3, delimiter=",")
    #SCC1.to_csv("/student/tsi2/r-venv/ra-code/cg_all_DE_norm_log2_divide/scc1_newmask.csv")
    #SCC2.to_csv("/student/tsi2/r-venv/ra-code/cg_all_DE_norm_log2_divide/scc2_newmask.csv")
    #SCC3.to_csv("/student/tsi2/r-venv/ra-code/cg_all_DE_norm_log2_divide/scc3_newmask.csv")
    ...
    #print("The imputated data i has been saved to {0} RMSE: {1}".format(outputFileName5, rmse5))
